...
describe("2019 day 2 part 1", () => {
	...
	it("should return the number for the ammount of fuel required given the aocinput", () => {
		const result = solvePart1(aocInput);
		assert.equal(result, 3182375);
	});
});
...
describe("2019 day 2 part 2", () => {
	...
	it.only("should return the number for the ammount of fuel required given the aocinput", () => {
		const result = solvePart2(aocInput);
		assert.equal(result, 4770725);
	});
});