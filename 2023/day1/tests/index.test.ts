...
const exampleInput1: string[] = ["1abc2", "pqr3stu8vwx", "a1b2c3d4e5f", "treb7uchet"];
...
describe("day 1 part 1", () => {
	it("Should give a sum of numbers using only numbers, given the example input", () => {
		const result = solvePart1(exampleInput1);
		assert.equal(result, 142);
	});
	it("Should give a sum of numbers, using only numbers, given the AoC input", () => {
		const result: number = solvePart1(aocInput);
		assert.equal(result, 54697);
	});
});

describe("day 1 part 2", () => {
	it("Should give a sum of numbers using only words, given the example input", () => {
		const result = solvePart2(exampleInput2);
		assert.equal(result, 281);
	});

	it("Should give a sum of numbers using only words, given the AoC input", () => {
		const result = solvePart2(aocInput);
		assert.equal(result, 54885);
	});
});
