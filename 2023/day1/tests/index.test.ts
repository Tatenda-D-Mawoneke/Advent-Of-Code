...
import { numberCalibrator, trueCalibrator } from "../src/index.js";

describe("numberCalibrator", () => {
	it("Should give a sum of numbers using only numbers, given some random string array with numbers and letters", () => {
		const words: string[] = ["1abc2", "pqr3stu8vwx", "a1b2c3d4e5f", "treb7uchet"];
		const result = trueCalibrator(words);
...
describe("numberCalibrator", () => {
	it("Should give a sum of numbers, using only numbers, given some random string array with numbers and letters", () => {
		...
		const result: number = numberCalibrator(words);
		assert.equal(result, 54697);
	});
});

describe("trueCalibrator", () => {
	it("Should give a sum of numbers using only words, given some random string array with numbers and letters", () => {
		const words: string[] = [
			"two1nine",
			"eightwothree",
			"abcone2threexyz",
